        ...
        public async Task<IActionResult> EmailCategory(EmailCategoryViewModel ecvm)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    return RedirectToAction("Index", "Categories", new { swalMessage = "Success: Emal Sent!" });
                }
                catch
                {
                    return RedirectToAction("Index", "Categories", new { swalMessage = "Error: Emal Send Failed!" });
                    throw;
                }
            }
